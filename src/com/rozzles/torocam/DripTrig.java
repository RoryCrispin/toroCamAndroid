...
public class DripTrig extends toroCamTrigger {
	...
	public void sendCapture() {
		...
		sendToroCamMessage("4," + micSens + "," + ldrSens + ","
				+ (dlengthSlide.getProgress()) + "," + (dnoSlide.getProgress())
				+ "," + (dbdSlide.getProgress()) + ","
				+ (flashSlide.getProgress()) + ",0,0,0!");
	}

	public void Recal(View v) {
		sendToroCamMessage("9,0,0,0,0,0,0,0,0,0!");
	}
